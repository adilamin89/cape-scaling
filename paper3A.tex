...
The capability manifold undergoes dimensional collapse ($d_{\rm eff}$: $2 \to 1$), a Riccati ODE governs the eigenvector rotation through the transition, and a coupled dynamical system discovered via sparse regression reproduces all five benchmark trajectories at 3.6\% error.
