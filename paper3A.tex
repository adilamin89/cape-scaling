...
CAPE makes this coupling measurable, predictable, and designable---the full protocol requires only published evaluation scores, no model weights, and reduces to a single formula that works unchanged across all three regimes (a worked example taking three scores to a regime diagnosis is in Appendix~C).
