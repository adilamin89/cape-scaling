...
The physics at each critical scale maps onto a different symmetry class (Fig.~\ref{fig:nc3}c).
...
\medskip
\noindent\textbf{Worked example: diagnosing a frontier model release.}
