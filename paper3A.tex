...
The ratio $\kappa(N) \equiv \lambda_1/\lambda_2$ is the GL coherence parameter---a dimensionless measure of how sharply the capability manifold is anisotropic.
...
Extrapolation predicts $\kappa\to\infty$ at the scale where $\lambda_2\to0$ ($\sim$88B from the $d_{\rm eff}=1$ crossing), consistent with the theory breakdown at $\sim$130B predicted from $\det(H)\to0$.
