...
CAPE makes this coupling measurable, predictable, and designable---the full protocol requires only published evaluation scores, no model weights, and reduces to a single formula that works unchanged across all three regimes (Appendix~C).
...
Computational assistance with symbolic regression and literature synthesis: Claude (Anthropic).
