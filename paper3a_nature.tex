...
At 66B, coupling shows partial recovery ($0.396$), mirroring the Nc1 pattern
where Pythia drops at 1B and recovers by 2.8B.
This is the first internal evidence of the cascade:
cooperation peaks, weakens at a new bottleneck, and begins to recover---the
same sequence that governs the base-scale transition, repeating at higher scale.
