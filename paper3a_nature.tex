...
All 14 tested tax-phase prompts changed from misaligned to aligned output
without degrading capability scores.
On Pythia-2.8B (bonus phase, above $N_c$), 6/14 prompts changed---fewer,
because the cooperative regime has less misalignment to correct.
Steering works in both phases but is most impactful where the tax is active
